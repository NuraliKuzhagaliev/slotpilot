...
const defaults={ASSEMBLYAI_API_KEY:'',SUPABASE_URL:'',SUPABASE_SECRET_KEY:'',SUPABASE_SERVICE_ROLE_KEY:'',SESSION_SECRET:randomBytes(48).toString('hex'),DEMO_NAMESPACE:'slotpilot-demo',VOICE_MAX_SESSION_SECONDS:'300',VOICE_DAILY_TOKEN_LIMIT:'10'};
